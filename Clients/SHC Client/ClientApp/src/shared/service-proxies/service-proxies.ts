...
export class TokenAuthServiceProxy {
     ...
     * @return Success
     */
    captcha(): Observable<AuthenticateResultModel> {
        let url_ = this.baseUrl + "/get-captcha-image";
        url_ = url_.replace(/[?&]$/, "");
...
export class CreateRouterDto implements IRouter {
    serviceTitle?: string;
    display?: boolean;
    ...
    init(data?: any) {
        if (data) {
            ...
            this.downstreamPathTemplate = data["downstreamPathTemplate"];
            this.upstreamPathTemplate = data["upstreamPathTemplate"];
            if (data["upstreamHttpMethod"] && data["upstreamHttpMethod"].constructor === Array) {
                this.upstreamHttpMethod = [];
                for (let item of data["upstreamHttpMethod"])
                    this.upstreamHttpMethod.push(item);
            }
            this.routeClaimsRequirement = data["routeClaimsRequirement"];
            this.addQueriesToRequest = data["addQueriesToRequest"];
            this.requestIdKey = data["requestIdKey"];
            this.fileCacheOptions = data["fileCacheOptions"];
            this.reRouteIsCaseSensitive = data["reRouteIsCaseSensitive"];
            this.serviceName = data["serviceName"];
            this.downstreamScheme = data["downstreamScheme"];
            this.qoSOptions = data["qoSOptions"];
            this.loadBalancerOptions = data["loadBalancerOptions"];
            this.rateLimitOptions = data["rateLimitOptions"];
            this.authenticationOptions = data["authenticationOptions"];
            this.httpHandlerOptions = data["fullhttpHandlerOptionsame"];
            this.downstreamHostAndPorts = data["downstreamHostAndPorts"];
            this.upstreamHost = data["upstreamHost"];
            this.key = data["key"];
            this.delegatingHandlers = data["delegatingHandlers"];
            this.priority = data["priority"];
            this.timeout = data["timeout"];
            this.dangerousAcceptAnyServerCertificateValidator = data["dangerousAcceptAnyServerCertificateValidator"];
            this.securityOptions = data["securityOptions"];
            this.swaggerKey = data["swaggerKey"];
        }
    }

    static fromJS(data: any): CreateRouterDto {
        data = typeof data === 'object' ? data : {};
        let result = new CreateRouterDto();
        result.init(data);
        return result;
    }
    ...
    toJSON(data?: any) {
        ...
        data["upstreamHttpMethod"] = this.upstreamHttpMethod;
        data["routeClaimsRequirement"] = this.routeClaimsRequirement;
        data["addQueriesToRequest"] = this.addQueriesToRequest;
        data["requestIdKey"] = this.requestIdKey;
        data["fileCacheOptions"] = this.fileCacheOptions;
        data["reRouteIsCaseSensitive"] = this.reRouteIsCaseSensitive;
        data["serviceName"] = this.serviceName;
        data["downstreamScheme"] = this.downstreamScheme;
        data["qoSOptions"] = this.qoSOptions;

...
export class IndexComponent extends AppComponentBase implements OnInit {
    ...
    ngOnInit() {
        ...
        this.frmResetPassword = this._formBuilder.group({
            ...
            NewPassword: [this._obj.NewPassword, [Validators.required, this.validateRule.hasValue, this.validateRule.passwordValidate]],
            UserName: this.appSession.user.userName,
            RePassword: ['', [Validators.required, this.validateRule.hasValue, this.validateRule.passwordValidate]],
    ...
    checkCapcha() {
        if (this.frmResetPassword.controls['capcha'].value == null || undefined || '') {
    ...
    resetPassword() {
        ...
        //    return swal({
        //        title: 'Thông báo',
        //        text: 'Đổi mật khẩu không thành công. Mật khẩu mới không được trùng mật khẩu hiện tại',
        //        type: 'warning',
        //        timer: 3000
        //    });
        //}

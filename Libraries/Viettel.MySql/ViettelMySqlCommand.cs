...
{
    public class ViettelMySqlCommand : IDbCommand, IDisposable
    {
        IDbCommand _dbCommand;
        public ViettelMySqlCommand(IDbCommand dbCommand)
        {
        ...
        {
            return new ViettelMySqlDataReader(this._dbCommand.ExecuteReader());
        }
        public IDataReader ExecuteReader(CommandBehavior behavior)
        {
            return new ViettelMySqlDataReader(this._dbCommand.ExecuteReader(behavior));
        }

...
{
    public class ViettelOracleCommand : IDbCommand, IDisposable
    {
        IDbCommand _dbCommand;
        public ViettelOracleCommand(IDbCommand dbCommand)
        {
        ...
        {
            return new ViettelOracleDataReader(this._dbCommand.ExecuteReader());
        }
        public IDataReader ExecuteReader(CommandBehavior behavior)
        {
            return new ViettelOracleDataReader(this._dbCommand.ExecuteReader(behavior));
        }

...
{
    public class ViettelOracleConnection : IDbConnection, IDisposable
    {
        IDbConnection _dbConnection;
        public ViettelOracleConnection(IDbConnection dbConnection)
        {
        ...
        {
            return new ViettelOracleCommand(this._dbConnection.CreateCommand());
        }
        public void Open()
        {

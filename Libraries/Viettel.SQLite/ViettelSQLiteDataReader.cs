...
{
    public class ViettelSQLiteDataReader : IDataReader, IDataRecord, IDisposable
    {
        IDataReader _reader;
        ViettelSQLiteCommand _cmd;
        bool _hasReleaseLock = false;
        public ViettelSQLiteDataReader(IDataReader reader, ViettelSQLiteCommand cmd)
        {
            this._reader = reader;
            this._cmd = cmd;
        }

        ~ViettelSQLiteDataReader()
        {
            this.Dispose();
        }

...
{
    public class ViettelSQLiteCommand : IDbCommand, IDisposable
    {
        IDbCommand _dbCommand;
        ViettelSQLiteConcurrentConnection _conn;
        public ViettelSQLiteCommand(IDbCommand dbCommand, ViettelSQLiteConcurrentConnection conn)
        {
            this._dbCommand = dbCommand;
            this._conn = conn;
        }

        public ViettelSQLiteConcurrentConnection Conn { get { return this._conn; } }
        ...
        public IDbTransaction Transaction
        {
            ...
            set
            {
                ViettelSQLiteTransaction tran = value as ViettelSQLiteTransaction;
                if (tran != null)
        ...
        public IDataReader ExecuteReader()
        {
            ...
            try
            {
                return new ViettelSQLiteDataReader(this._dbCommand.ExecuteReader(), this);
            }
            catch
            {
        ...
        public IDataReader ExecuteReader(CommandBehavior behavior)
        {
            ...
            try
            {
                /* 不出异常的话要锁的释放留给 ViettelSQLiteDataReader 去执行 */
                return new ViettelSQLiteDataReader(this._dbCommand.ExecuteReader(behavior), this);
            }
            catch
            {
                /* 出异常的话要释放锁 */

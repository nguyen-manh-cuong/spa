...
namespace Viettel.SQLite
{
     ...
     */
    public class ViettelSQLiteConcurrentConnection : IDbConnection, IDisposable
    {
        ...
        public ViettelSQLiteConcurrentConnection(IDbConnection dbConnection)
        {
        ...
        public IDbTransaction BeginTransaction()
        {
            ...
            return new ViettelSQLiteTransaction(this._dbConnection.BeginTransaction(), this);
        }
        public IDbTransaction BeginTransaction(IsolationLevel il)
        {
            if (this._rwLock.IsInTransaction)
                throw new Exception("Current connection has begun a transaction.");
            return new ViettelSQLiteTransaction(this._dbConnection.BeginTransaction(il), this);
        }
        ...
        {
            return new ViettelSQLiteCommand(this._dbConnection.CreateCommand(), this);
        }
        public void Open()
        {

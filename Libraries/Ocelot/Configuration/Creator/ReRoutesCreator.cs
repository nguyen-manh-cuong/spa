    ...
    public class ReRoutesCreator : IReRoutesCreator
    {
        ...
        private DownstreamReRoute SetUpDownstreamReRoute(FileReRoute fileReRoute, FileGlobalConfiguration globalConfiguration)
        {
            ...
            var reRoute = new DownstreamReRouteBuilder()
                ...
                .WithApplicationName(fileReRoute.ApplicationName)
                .WithServiceTitle(fileReRoute.ServiceTitle)
                .WithServiceGroup(fileReRoute.ServiceGroup)
                .WithServiceDisplay(fileReRoute.Display)

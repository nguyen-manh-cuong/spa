...
namespace Ocelot.Configuration.Builder
{
    public class DownstreamReRouteBuilder
    {
        ...
        public DownstreamReRouteBuilder WithApplicationName(string applicationName)
        {
            _applicationName = applicationName;
            return this;
        }
        public DownstreamReRouteBuilder WithServiceTitle(string serviceTitle)
        {
            _serviceTitle = serviceTitle;
            return this;
        }

        public DownstreamReRouteBuilder WithServiceGroup(string serviceGroup)
        {
            _serviceGroup = serviceGroup;
            return this;
        }

        public DownstreamReRouteBuilder WithServiceDisplay(bool display)
        {
            _display = display;
            return this;
        }

...
namespace Viettel.Entity
{
    public class EntityType
    {
        ...
        public virtual TypeDefinition MakeDefinition()
        {
            ...
            {
                /* 限定自增类型 */
                throw new ViettelException("Auto increment member type must be Int16, Int32 or Int64.");
            }
            ...
            {
                /* 自增列不能作为联合主键 */
                throw new ViettelException("Auto increment member can not be union key.");
            }

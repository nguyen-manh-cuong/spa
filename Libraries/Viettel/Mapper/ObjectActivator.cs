    ...
    public class ObjectActivator : IObjectActivator
    {
        ...
        public virtual object CreateInstance(IDataReader reader)
        {
            ...
            catch (Exception ex)
            {
                ...
                {
                    throw new ViettelException(AppendErrorMsg(reader, this._readerOrdinalEnumerator.CurrentOrdinal, ex), ex);
                }
            ...
            catch (Exception ex)
            {
                ...
                if (binder != null)
                {
                    throw new ViettelException(AppendErrorMsg(reader, binder.Ordinal, ex), ex);
                }

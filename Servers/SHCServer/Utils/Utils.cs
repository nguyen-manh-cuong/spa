...
namespace SHCServer
{
    ...
    public class Utils
    {
        ...
        public static SmsRespone SendSMS(IConfiguration configuration, SmsContent content, List<SmsPackageUsed> lstSmsPackageUsed, List<MedicalHealthcareHistories> lstMedicalHealthcareHistories, int type = 1)
        {
        ...
        public static SmsRespone SendListSMS(IConfiguration configuration, List<SmsContent> lst, List<SmsPackageUsed> lstSmsPackageUsed, List<MedicalHealthcareHistories> lstMedicalHealthcareHistories, int type = 1)
        {
            long code = 0;
            int failSms = 0;
            int total = lst.Count;

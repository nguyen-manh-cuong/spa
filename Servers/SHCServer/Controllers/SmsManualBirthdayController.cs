...
{
    public class SmsManualBirthdayController : BaseController
    {
        private readonly string _connectionString;
        private string nameData;

        public SmsManualBirthdayController(IOptions<Audience> settings, IConfiguration configuration)
        {
            _settings = settings;
